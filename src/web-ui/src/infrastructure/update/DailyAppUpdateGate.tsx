...
import { DailyUpdatePromptToast } from './DailyUpdatePromptToast';
 ...
 * Renders the daily update prompt and install progress UI; mount once near the app root.
 */
